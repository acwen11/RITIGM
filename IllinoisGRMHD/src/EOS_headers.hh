...
void apply_floors_and_ceilings_to_prims__recompute_prims( const igm_eos_parameters eos, const CCTK_REAL *restrict METRIC_LAP_PSI4, CCTK_REAL *restrict PRIMS, const CCTK_REAL shiftx,const CCTK_REAL shifty,const CCTK_REAL shiftz,const CCTK_REAL rho_b_atm, const CCTK_REAL T_atm );
