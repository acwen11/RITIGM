...
static inline int VI_GRMHD_number_of_reductions(int which_integral) {
  ...
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"density_weighted_norm_B_field")) return 2;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"volume_average_norm_B_ab")) return 4;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"volume_average_norm_B_cd")) return 4;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"kinetic_energy")) return 3;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"kinetic_energy_palenzuela")) return 3;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"kinetic_energy_shibata")) return 3;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"thermal_energy")) return 3;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"magnetic_energy_total")) return 2;
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"magnetic_energy_comov")) return 1;
  ...
  if(CCTK_EQUALS(Integration_quantity_keyword[which_integral],"neutrino_lum")) return 3;
