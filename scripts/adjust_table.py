...
output_tablepath   = original_tablepath.split(".h5")[0]+"_adjusted.h5"
...
# Step 3c: Compute m_f = (1-eps_0)*m_u
mf = UAMU_MEV*(1.0 - eps0/C_CGS**2)
...
table["logenergy"   ][...] = np.log10(eps)
# Step 8c: Sound speed
table["cs2"         ][...] = cs2*h
# Step 8d: Energy shift
table["energy_shift"][...] = 0
