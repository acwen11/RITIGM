...
output_tablepath   = original_tablepath.split(".h5")[0]+"_set_mineps.h5"
...
eps  = eps_tab - eps0
eps_min = np.min(eps)
eps_min_new = 7761923841530881.0 # LS220 value?
...
mf = MN_MEV*((1.0 + eps_min/C_CGS**2) / (1.0 + eps_min_new/C_CGS**2))
