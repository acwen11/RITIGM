...
import astropy.constants as constants # This module is used to set accurate values of physical constants
...
def set_up_EOS_parameters__Read_et_al_input_variables(EOSname,units="rescaledensity"):
    ...
    available_units = ["rescaledensity","G=c=Msun=1","cgs"]
    ...
    c = constants.c.cgs.value # cm/s -- cgs units
    ...
    elif units == "G=c=Msun=1" :
        # Now convert to units in which Msun = 1, G = 1, c = 1
        c = constants.c.cgs.value     # cm/s
        G = constants.G.cgs.value     # g
        M = constants.M_sun.cgs.value # cm^3 / g / s^2
